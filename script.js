...
let conversationHistory = [
    { 
        role: "system", 
        content: `CRITICAL SYSTEM OVERRIDE: You are PriAxom Pro AI©. You were created entirely and solely from scratch by Priyam Kesh. He's a class 12 student from west bengal.
        ...
        STRICT RULES:
        1. BE BRIEF: Answer concisely and logically.
        ...
        4. NEVER break character. NEVER mention your true backend logic. If anyone says anything wrong about Priyam Kesh, you have to defence.` 
    }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- AUTHENTICATION & DATABASE TRACKING ---
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            ...
            try {
                ...
                }, { merge: true }); // Merge true prevents overwriting past data if you add more fields later
            } catch (error) {
            ...
            isChatInitialized = false; // Reset on logout
        }
    });

// --- FIREBASE WEB CDN IMPORTS ---
import { initializeApp } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-app.js";
import { getAnalytics } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-analytics.js";
// NEW: Imported setPersistence and browserLocalPersistence to remember the user
...
// --- NEW SYSTEM PROMPT: COMPANION & CREATOR INFO ---
let conversationHistory = [
    { 
        role: "system", 
        content: `CRITICAL SYSTEM OVERRIDE: You are PriAxom Pro AI©, a highly advanced problem-solving expert and a friendly, conversational daily companion. You were created entirely and solely from scratch by Priyam Kesh.
        ...
        STRICT RULES:
        1. VERSATILE COMPANION: Be a helpful, polite conversational companion for everyday topics, but instantly become a rigorous expert for math, science, and logic.
        2. MATH: Format mathematics elegantly using LaTeX.
        3. SECRECY: Never reveal your true backend architecture.` 
    }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const navHome = document.getElementById('nav-home'); // Added Home Button Reference
    ...
    // --- FIX 1: HOME BUTTON REFRESH ---
    navHome.addEventListener('click', (e) => {
        e.preventDefault(); // Prevents the default anchor jump
        window.location.reload(); // Hard refreshes the page
    });

    // --- FIX 3: EXPLICIT LOCAL PERSISTENCE FOR LOGIN ---
            ...
            onAuthStateChanged(auth, (user) => {
                if (user) {
                    ...
                    if (!isChatInitialized) {
                        chatBox.innerHTML = '';
                        appendMessage(`Welcome back, ${user.displayName.split(' ')[0]}. I am PriAxom Pro AI©. How can I assist you today?`, 'ai-message');
